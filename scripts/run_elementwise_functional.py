#!/usr/bin/env python3
"""Build and run H160 elementwise configs in three C++ modes."""
...
def main() -> int:
    ...
    compiler = json.loads(
        (output_root / "elementwise-functional-compile-manifest.json").read_text()
    )
    ...
    path = output_root / "elementwise-functional-run-manifest.json"
