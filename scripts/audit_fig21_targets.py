#!/usr/bin/env python3
"""Run the pre-registered H25 full Figure 21 target audit."""
...
from mlxsim.fig21_digitization import (
    CONFIG_PATH,
    PROJECT_ROOT,
    load_fig21_target_config,
    run_fig21_target_completion,
)
...
def main() -> int:
    ...
    config = load_fig21_target_config(args.config)
    ...
    report = {
        "project_git_revision": _git_commit(),
        **run_fig21_target_completion(config),
    }
