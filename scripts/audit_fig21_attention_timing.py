#!/usr/bin/env python3
"""Audit H93 batch-8 Figure 21 Attention timing."""
...
def build_audit(config: dict[str, Any]) -> dict[str, Any]:
    ...
    compile_path = output_root / "fig21-attention-compile-manifest.json"
    run_path = output_root / "fig21-attention-run-manifest.json"
    ...
    for shape_name, contract in contracts.items():
        ...
        full_checks[shape_name] = (
            base["offchip_bytes"] * full_scale // 4
            == contract["structured_components"]["attention"]["combined_offchip_bytes"]
            and base["boundary_bytes"] * full_scale // 4
            == contract["structured_components"]["attention"]["boundary_bytes"]
        )
    numerical = {
