...
def source_identity():
    files = [Path(__file__).resolve(), ROOT / "src/mlxsim/model_tensor_compiler.py", ROOT / "src/mlxsim/model_matrix_program.py", ROOT / "src/mlxsim/model_vector_program.py", ROOT / "src/mlxsim/model_dtype_lowering.py", ROOT / "src/mlxsim/model_memory_program.py", ROOT / "src/mlxsim/model_control_program.py"]
    for directory in (ROOT / "simulator_ext/tensor_model", ROOT / "simulator_ext/tagged", ROOT / "simulator_ext/matrix_schedule", ROOT / "simulator_ext/vector_model", ROOT / "simulator_ext/vector_schedule", ROOT / "simulator_ext/model_io", ROOT / "simulator_ext/memory_model", ROOT / "simulator_ext/control_model", ROOT / "simulator_ext/control_schedule", ROOT / "simulator_ext/shared_array"):
