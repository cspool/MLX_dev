#!/usr/bin/env python3
"""Build and run H161 complete-block configs in three C++ modes."""
...
def main() -> int:
    ...
    compiler = json.loads(
        (output_root / "complete-block-functional-compile-manifest.json").read_text()
    )
    ...
    path = output_root / "complete-block-functional-run-manifest.json"
