#!/usr/bin/env python3
"""Build and run H159 SWA configs in three C++ modes."""
...
def main() -> int:
    ...
    compiler = json.loads((output_root / "swa-functional-compile-manifest.json").read_text())
    ...
    path = output_root / "swa-functional-run-manifest.json"
