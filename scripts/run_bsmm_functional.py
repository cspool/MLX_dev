#!/usr/bin/env python3
"""Build and run H156 BSMM configs in three C++ modes."""
...
def main() -> int:
    ...
    compiler = json.loads(
        (output_root / "bsmm-functional-compile-manifest.json").read_text()
    )
    ...
    path = output_root / "bsmm-functional-run-manifest.json"
