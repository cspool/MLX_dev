#!/usr/bin/env python3
"""Build and run H157 FFT-CMP configs in three C++ modes."""
...
def main() -> int:
    ...
    compiler = json.loads(
        (output_root / "fft-cmp-functional-compile-manifest.json").read_text()
    )
    ...
    path = output_root / "fft-cmp-functional-run-manifest.json"
