...
CONFIG_ROOT=${MLX_ORIN_CONFIG_ROOT:-$PROJECT_ROOT/artifacts/environment/h54/config}
OUTPUT_ROOT=${MLX_ORIN_OUTPUT_ROOT:-$PROJECT_ROOT/artifacts/smoke/gpgpusim-orin-proxy}
BUILD_ROOT=${MLX_ORIN_BUILD_ROOT:-$PROJECT_ROOT/build/gpgpusim-orin-proxy}
...
PYTHONPATH="$PROJECT_ROOT/src:$PROJECT_ROOT" "$PROJECT_ROOT/.venv/bin/python" \
  "$PROJECT_ROOT/scripts/build_gpgpusim_orin_config.py" \
...
echo "execution-driven GPGPU-Sim Orin proxy passed"
