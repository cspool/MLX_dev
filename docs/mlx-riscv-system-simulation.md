...
repair4 的 21–24 条平台期从未进入该流程。repair5 已于 2026-09-02 15:21 UTC
使用显式阈值 64 启动同一
...
10%/20%/30%/40% 时分别为 2/9/9/9 条 partial violations、用时
29:31/1:01:24/1:30:24/2:02:23，优于 repair4 同点的 5/16/19 条；该计数会随扫描区域
增加，明确不作为最终 DRC。默认阈值仍为 11，不修改规则或签核门禁。
