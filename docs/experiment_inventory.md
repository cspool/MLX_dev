...
| Fig. 15(c,d) | Llama2/InternLM2 LoRA accuracy/perplexity and compute | Fine-tuning/evaluation | Model recipes, cached targets, FLOP model | yes | compute + target digitizer + original PPL + H20/H27 runners yes | original PPLs pass; H27 unmodified WinoGrande rejects (69.61% vs 90.1%) while matching Llama2's published 69.2%; H20 FFT/LoRA rejected (46.86%, causal leakage); task-adapted and full compressed variants no |
