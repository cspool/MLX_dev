...
| Fig. 15(c,d) | Llama2/InternLM2 LoRA accuracy/perplexity and compute | Fine-tuning/evaluation | Model recipes, cached targets, FLOP model | yes | compute + target digitizer + original PPL + H20/H27/H28/H30/H31 + H29 source audit yes | original PPLs pass; H27 base WinoGrande rejects at 69.61%, while H28's inferred dense task-adapted LoRA passes at 87.85% vs 90.1%; H30 historical InternLM2/Ada baseline rejects at 57.8/46.9/27.4%, and H31's three 4k seed schedules remain 27.6%-30.3%; H20 FFT/LoRA rejected (46.86%, causal leakage); H29 proves the full compressed recipe publicly underidentified; full compressed variants no |
