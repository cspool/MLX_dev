...
| Fig. 15(c,d) | Llama2/InternLM2 LoRA accuracy/perplexity and compute | Fine-tuning/evaluation | Model recipes, cached targets, FLOP model | yes | compute + target digitizer + both original PPL runners yes | InternLM original pass (3.91%); Llama2 original pass (7.91%); compressed/LoRA variants no |
