...
| Fig. 15(c,d) | Llama2/InternLM2 LoRA accuracy/perplexity and compute | Fine-tuning/evaluation | Model recipes, cached targets, FLOP model | yes | compute + target digitizer + original PPL + H20/H27/H28 runners yes | original PPLs pass; H27 base WinoGrande rejects at 69.61%, while H28's inferred dense task-adapted LoRA passes at 87.85% vs 90.1%; H20 FFT/LoRA rejected (46.86%, causal leakage); full compressed variants no |
