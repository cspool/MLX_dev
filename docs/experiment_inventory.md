...
| Fig. 15(c,d) | Llama2/InternLM2 LoRA accuracy/perplexity and compute | Fine-tuning/evaluation | Model recipes, cached targets, FLOP model | yes | compute + target digitizer + InternLM original PPL yes | InternLM/WikiText-2 original pass (3.91% error); H19 Llama2 original pending; compressed/LoRA variants no |
