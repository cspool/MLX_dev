...
| Table V / Fig. 19 | FPGA resources and FABNet latency breakdown | FPGA implementation/simulation | Resource replay + workload timing model | yes | yes | stacks complete; official FABNet rejected (288.2% max); H23 MLX event transfer rejected (57.2% component max, FFN MAPE 11.0%); FPGA timing not reproduced |
