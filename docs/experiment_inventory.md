...
| Table V / Fig. 19 | FPGA resources and FABNet latency breakdown | FPGA implementation/simulation | Resource replay + workload timing model | yes | yes | target stacks complete; reported arithmetic pass; official FABNet totals/components rejected (288.2% max); MLX FPGA timing not reproduced |
