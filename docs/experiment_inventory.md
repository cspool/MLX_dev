...
| Fig. 22 | PE pipeline utilization on BSMM and chunk FFT | Cycle simulation | Event-simulator utilization sweep | partial | no | no |
| Fig. 23 | SIMD and mesh scalability | Cycle simulation | Architecture sweep | yes | no | no |
