...
完成状态：H162/run167 已通过 12/12 门槛。核心架构趋势 claim 为 5/5，
支撑 claim 为 3/3，最小/最大提升为 1.215x/15.018x；BSMM、FFT-CMP、
Attention、SWA、elementwise 与完整 block 的同输入功能覆盖为 6/6。H161
在一个 365-cycle、54-PE、13-tag 仿真中动态连接五类算子，所有边界及最终
输出均匹配 NumPy，最大误差 2.78e-17。全仓 Ruff 通过，pytest 为 416
passed、0 failed、17 warnings。该完成结论不要求 RTL、功耗/面积、整图覆盖
或严格 10% 数值误差；未来若重开具体 claim，继续执行上述跨实验转向规则。
