...
def main():
    ...
    test_count,replay_count,success_count=(55,58,37) if args.include_loops else (35,29,18)
    ...
    if args.include_loops:copies[ROOT/"docs/mlx-event-loop-ir.md"]=Path("sources/docs/mlx-event-loop-ir.md")
