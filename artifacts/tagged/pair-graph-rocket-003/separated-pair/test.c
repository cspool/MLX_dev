...
static const volatile mlx_graph_asset assets[]={{.source=(uintptr_t)(payload_blob+0),.destination=UINT64_C(2164326400),.bytes=32},{.source=(uintptr_t)(payload_blob+32),.destination=UINT64_C(2164326464),.bytes=8}};
...
static const volatile struct check checks[]={{.base=UINT64_C(2164326720),.offset=0,.rank=2,.width=2,.count=4,.shape={1,4},.stride={4,1},.expected=expected_0},{.base=UINT64_C(2164326528),.offset=0,.rank=1,.width=8,.count=1,.shape={1},.stride={1},.expected=expected_1}};
...
if(result.device_calls!=3||result.asset_bytes!=40)return 14;
