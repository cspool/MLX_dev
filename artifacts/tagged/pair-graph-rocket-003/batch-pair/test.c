...
static const volatile mlx_graph_asset assets[]={{.source=(uintptr_t)(payload_blob+0),.destination=UINT64_C(2164326400),.bytes=120},{.source=(uintptr_t)(payload_blob+120),.destination=UINT64_C(2164326528),.bytes=560}};
...
static const volatile struct check checks[]={{.base=UINT64_C(2164327808),.offset=0,.rank=4,.width=4,.count=168,.shape={2,4,3,7},.stride={84,21,7,1},.expected=expected_0},{.base=UINT64_C(2164327104),.offset=0,.rank=3,.width=8,.count=24,.shape={2,4,3},.stride={12,3,1},.expected=expected_1}};
...
if(result.device_calls!=1||result.asset_bytes!=680)return 14;
