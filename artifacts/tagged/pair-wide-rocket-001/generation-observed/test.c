...
static const volatile mlx_graph_program program={.magic=MLX_GRAPH_MAGIC,.version=2,.source_count=45,.task_count=42,.asset_count=0,.assets=(uintptr_t)assets,.tasks=(uintptr_t)tasks,.device_base=UINT64_C(6459228160),.device_bytes=UINT64_C(1048576),.scratch_offset=4096,.scratch_bytes=16384,.poll_limit=UINT64_C(1000000000000),.completion=(uintptr_t)completion,.reserved={(uintptr_t)source_table,0,0}};
static const unsigned char expected_0[]={0,60,0,71,255,251,255,251};
static const unsigned char expected_1[]={1,0,0,0,0,0,0,0};
static const unsigned char expected_2[]={0,60,0,71,128,73,255,251};
static const unsigned char expected_3[]={2,0,0,0,0,0,0,0};
static const unsigned char expected_4[]={170,62,0,69,128,73,0,69};
static const unsigned char expected_5[]={2,0,0,0,0,0,0,0};
struct check {uint64_t base,offset,rank,width,count,shape[8],stride[8];const unsigned char *expected;};
static const volatile struct check checks[]={{.base=UINT64_C(6459294080),.offset=0,.rank=2,.width=2,.count=4,.shape={1,4},.stride={4,1},.expected=expected_0},{.base=UINT64_C(6459293952),.offset=0,.rank=1,.width=8,.count=1,.shape={1},.stride={1},.expected=expected_1},{.base=UINT64_C(6459294144),.offset=0,.rank=2,.width=2,.count=4,.shape={1,4},.stride={4,1},.expected=expected_2},{.base=UINT64_C(6459294016),.offset=0,.rank=1,.width=8,.count=1,.shape={1},.stride={1},.expected=expected_3},{.base=UINT64_C(6459294272),.offset=0,.rank=2,.width=2,.count=4,.shape={1,4},.stride={4,1},.expected=expected_4},{.base=UINT64_C(6459294208),.offset=0,.rank=1,.width=8,.count=1,.shape={1},.stride={1},.expected=expected_5}};
...
if(result.device_calls!=18||result.asset_bytes!=0)return 14;
