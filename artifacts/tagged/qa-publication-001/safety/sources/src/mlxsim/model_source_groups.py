...
def validate_source_groups(program):
    ...
    if groups is None:
        ...
        return
    if not isinstance(groups,list) or not groups or program["schema"] not in {"mlx_tensor_semantics_v3","mlx_tensor_semantics_v4"} or program.get("value_contract")!="source_groups_v1":
