...
struct Runner {
  ...
  Runner(const Json::Value &p,const Json::Value &options)
    ...
    require((program["schema"]=="mlx_tensor_semantics_v1"||program["schema"]=="mlx_tensor_semantics_v2"||program["schema"]=="mlx_tensor_semantics_v3"||program["schema"]=="mlx_tensor_semantics_v4")&&program["timing_mode"]=="unmodeled","invalid physical model program");
