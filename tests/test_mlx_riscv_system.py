...
def test_distributed_tile_candidate_is_promoted_but_not_final() -> None:
    ...
    assert top_floorplan["status"] == (
        "tile48_grt_iter5_complete_droute_local_repair5_running"
    )
    ...
    assert repair5_scan["completed_percent"] == 30
    assert repair5_scan["partial_violations"] == 9
    assert repair5_scan["elapsed_seconds"] == 5424
    assert repair5_scan["repair4_same_point_violations"] == 19
    assert repair5_scan["progress_points"] == [
        ...
        },
        {
            ...
            "partial_violations": 9,
            "elapsed_seconds": 5424,
            "repair4_same_point_violations": 19,
        },
    ]
