...
from scripts.audit_fig22_coupled_transfer import DEFAULT_CONFIG, build_audit


def test_fig22_coupled_transfer_audit() -> None:
    ...
    assert all(report["finite_checks"].values())
