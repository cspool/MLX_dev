...
FP16 input/output bytes, stage depth, and requests must reconstruct the H100
contracts. Boundary-event counts may increase when four folded strips become
16 independently ready strips, but every emitted event must have an exactly
balanced consumer under the registered per-event cadence.
